          ...
          <div className="mt-8 pt-4 border-t border-border/40">
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 font-semibold rounded-lg shadow-sm border ${
                pathname === '/dashboard/profile' ? 'bg-ecu-purple/10 text-ecu-purple border-ecu-purple/20' : 'text-foreground border-transparent hover:border-border hover:bg-muted/30'
              }`}
            >
